        ...
        <Wrapper>
             ...
             <div>
                ...
                <ol className=' list-disc list-outside md:ml-72 ml-2 md:mt-3'>
                    ...
                    <div>
                        {/* heading */}
                        <h5 className=' md:text-4xl text-3xl font-bold text-red-700 md:ml-72 ml-2 mt-3'>Cloud-Native Computing - Specialized Tracks</h5>
                        <p className=' text-lg text-center mt-2'>The Cloud-Native Computing Specialization focuses on Containers, 
                        Kubernetes, and CDK for Kubernetes.</p>
